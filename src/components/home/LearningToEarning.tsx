...
export function LearningToEarning() {
      ...
      <div className={`${container} relative grid items-center gap-16 lg:grid-cols-[1fr_1.05fr]`}>
        <Reveal>
          ...
          <p className="mt-6 max-w-lg text-base leading-relaxed text-white/70">
            Experienced instructors, hands-on software training, and a placement cell that stays with you. Every
            Finprov program carries 100% placement assistance — and our learners hold a{" "}
            {placementStats.placementRecord}% placement record across cohorts.
          </p>
