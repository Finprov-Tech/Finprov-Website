...
const photos = [
  { src: keralaStudents, cls: "left-[16%] top-[18%] h-28 w-28 -rotate-3" },
  { src: keralaAdvisor, cls: "right-[18%] top-[34%] h-24 w-24 rotate-2" },
  { src: heroMentor, cls: "left-[30%] bottom-[16%] h-24 w-24 rotate-6" },
];
