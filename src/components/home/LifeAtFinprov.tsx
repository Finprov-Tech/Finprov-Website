      ...
      <div className={container}>
        <div className="flex flex-wrap items-end justify-between gap-6">
          <Reveal>
            ...
            <h2 className="mt-4 text-4xl font-bold tracking-tight text-navy sm:text-5xl">Life at Finprov</h2>
            <p className="mt-3 max-w-lg text-base text-text-body">
              Celebrations, presentations, and industry visits — learning here looks a lot like the workplaces
              you're headed to, with more cake.
            </p>
          </Reveal>
      ...
      <Reveal delay={0.12}>
        ...
        >
          {lifeAtFinprov.map((event, i) => (
            ...
            >
              <PhotoSlot
                src={i === 0 ? keralaStudents : undefined}
                alt={event.title}
