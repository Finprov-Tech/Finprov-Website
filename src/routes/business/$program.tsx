...
export const Route = createFileRoute("/business/$program")({
  loader: ({ params }) => {
    const program = getBusinessProgram(params.program);
  ...
  head: ({ loaderData }) => ({
    meta: loaderData
      ? [
          { title: `${loaderData.title} | Finprov Business` },
          { name: "description", content: loaderData.description },
        ]
      : [],
  }),
  component: BusinessProgram,
});
        ...
        <div className={container}>
          <Reveal>
            ...
            <p className="mt-4 max-w-2xl text-text-body">
              The application journey is simple and straightforward, and can be completed in three
              easy steps.
            </p>
          </Reveal>
        ...
        <section className="section-ambient py-20">
          <div className={`${container} grid gap-10 lg:grid-cols-[0.85fr_1.15fr]`}>
            ...
            <div className="space-y-3">
              {program.detail.faqs.map(([question, answer]: [string, string], index: number) => (
        ...
        <div className={`${container} grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-center`}>
          <Reveal>
            ...
            <p className="mt-4 max-w-md leading-relaxed text-white/70">
              Tell us about your organisation, participants, and learning goals. Our team will help
