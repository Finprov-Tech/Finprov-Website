...
export const Route = createFileRoute("/verify-certificate")({
  head: () => ({
    meta: [
      { title: "Certificate Verification Portal | Finprov Learning" },
      {
        name: "description",
        content:
          "Verify authentic certificates issued by Finprov Learning. Instant verification portal for employers and learners.",
      },
    ],
  }),
...
// Sample verified database for verification check
