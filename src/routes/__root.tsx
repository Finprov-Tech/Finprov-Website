...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Industry-validated finance programs with SAP, Tally & Power BI training. 100% placement assistance for freshers and working professionals." },
      { name: "author", content: "Finprov" },
      { property: "og:title", content: "Finprov — Master Finance. Accelerate Your Global Career." },
      { property: "og:description", content: "Industry-validated finance programs with SAP, Tally & Power BI training. 100% placement assistance for freshers and working professionals." },
    ...
    links: [
      ...
      { rel: "icon", href: "/finprov-mark.jpeg", type: "image/jpeg" },
      { rel: "apple-touch-icon", href: "/finprov-mark.jpeg" },
      { rel: "preconnect", href: "https://fonts.googleapis.com" },
      { rel: "preconnect", href: "https://fonts.gstatic.com", crossOrigin: "anonymous" },
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Plus+Jakarta+Sans:wght@500;600;700;800&family=Caveat:wght@500;600;700&display=swap" },
    ],
  }),
