...
export const Route = createFileRoute("/blog/")({
  head: () => ({
    meta: [
      { title: "Blog & Journal — Finprov Learning" },
      {
        name: "description",
        content:
          "Practical guides on GST, SAP FICO, UAE Corporate Tax, Data Analytics, and Big 4 accounting placement strategies written by practicing CAs.",
      },
    ],
  }),
  component: BlogIndex,
...
// High-impact imagery presets for blog topics matching Baker Mountain Guides style
...
function BlogIndex() {
  ...
  return (
    <div className="min-h-screen bg-navy text-white selection:bg-gold selection:text-navy">
      ...
      {/* Hero Header matching Finprov Deep Navy Theme */}
      ...
      {/* Filter Navigation Bar matching Finprov Theme */}
      ...
      {/* Main Grid Layout with Theme-Aligned Colors */}
      <section className="py-14 sm:py-20 bg-navy/95">
        <div className={container}>
                  ...
                  <StaggerItem key={p.slug}>
                    <Link to="/blog/$slug" params={{ slug: p.slug }} className="block h-full">
                      ...
                      <article className="group relative h-[440px] w-full overflow-hidden rounded-2xl border border-white/10 bg-navy shadow-2xl transition-all duration-500 hover:border-gold/50 hover:shadow-emerald/20">
                        ...
                        {/* Theme Hover Color Shift (Finprov Navy/Emerald Shift) */}
          ...
          {/* Load More Button matching Finprov Theme */}
