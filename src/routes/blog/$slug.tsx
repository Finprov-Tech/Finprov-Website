...
export const Route = createFileRoute("/blog/$slug")({
  ...
  head: ({ loaderData }) => ({
    meta: loaderData
      ? [
          { title: `${loaderData.title} — Finprov Editorial Journal` },
...
// High-impact imagery presets matching blog topics
    ...
    <div className="min-h-screen bg-[#FAF9F6] text-slate-800 selection:bg-gold selection:text-navy">
      ...
      <article className="py-14 sm:py-20">
        <div className={container}>
          {/* Main Hero Cover Image (Baker Mountain Guides Photo Feature) */}
          ...
          <div className="mt-12 space-y-12 text-slate-700">
            {post.sections.map((s: any, i: number) => (
          ...
          {/* Professional Takeaways Highlight */}
      ...
      {/* Related Articles Section (Baker Mountain Guides Photo Card Style) */}
      {related.length > 0 && (
        <section className="bg-slate-900 py-16 text-white border-t border-white/10">
          <div className={container}>
            <div className="flex items-center justify-between border-b border-white/10 pb-4 mb-8">
              ...
              <Link to="/blog" className="text-xs font-bold text-gold hover:underline uppercase flex items-center gap-1">
