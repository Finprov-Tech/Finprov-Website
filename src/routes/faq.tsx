...
export const Route = createFileRoute("/faq")({
  head: () => ({
    meta: [
      { title: "Frequently Asked Questions (FAQ) | Finprov Learning" },
      {
        name: "description",
        content:
          "Find answers to common questions about Finprov courses, admissions, eligibility, payment options, online access, and placements.",
      },
    ],
  }),
  component: FaqPage,
...
interface FaqItem {
  id: string;
  category: "General" | "Learning & Access" | "Payments & EMI" | "Placements & Certificates";
  question: string;
  answer: string;
}
...
const officialFaqs: FaqItem[] = [
  ...
  {
    id: "faq-7",
    category: "Placements & Certificates",
...
const categories = ["All", "General", "Learning & Access", "Payments & EMI", "Placements & Certificates"] as const;
      ...
      <section className="relative overflow-hidden bg-navy py-16 text-white">
        ...
        <div className={`${container} relative text-center`}>
          <div className="mx-auto inline-flex items-center gap-2 rounded-full border border-gold/40 bg-gold/10 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-gold">
            <HelpCircle className="h-4 w-4" /> Support &amp; Answers
          </div>
