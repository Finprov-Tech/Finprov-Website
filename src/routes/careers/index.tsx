...
import { Briefcase, Building2, CheckCircle2, ChevronRight, Compass, GraduationCap, Mail, MapPin, Phone, Search, Send, Sparkles, User, Users } from "lucide-react";
...
export const Route = createFileRoute("/careers/")({
  head: () => ({
    meta: [
      { title: "Careers at Finprov — Explore Job Openings & Join Our Team" },
      { name: "description", content: "Explore exciting career opportunities at Finprov Learning across growth, sales, marketing, technology, academics, and operations. Apply today to build a rewarding career." },
    ],
  }),
        ...
        <div className={container}>
          <Reveal>
            <div className="text-center max-w-2xl mx-auto">
              <span className="text-xs font-bold uppercase tracking-wider text-teal">Life at Finprov</span>
      ...
      <section className="bg-navy py-16 text-white">
        <div className={`${container} text-center`}>
          <div className="max-w-2xl mx-auto">
            <h2 className="text-2xl font-extrabold sm:text-3xl">Don't see the right position?</h2>
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              ...
              <a
                href={`https://wa.me/${careerHero.applyPhone.replace(/[^0-9]/g, '')}`}
                target="_blank"
              ...
              >
                <Phone className="h-4 w-4" /> WhatsApp HR ({careerHero.applyPhone})
              </a>
            </div>
          </div>
        </div>
