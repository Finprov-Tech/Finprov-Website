...
function About() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Hero Section (No Top CTA Button as requested) */}
      <section className="relative overflow-hidden bg-navy pt-28 pb-14 text-white">
        ...
        <div className={`${container} relative grid gap-8 lg:grid-cols-[1.2fr_0.9fr] lg:items-center`}>
          <div>
            ...
            >
              <Sparkles className="h-3.5 w-3.5" /> About Finprov Learning
            </motion.span>
            <motion.h1
            ...
            >
              We Started Small. <span className="text-gold">Now We're Building Futures.</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 16 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            <PhotoSlot
              src={keralaStudents}
              alt="Finprov learners collaborating in the classroom"
      ...
      <section className="border-b border-border bg-white py-8 sm:py-10">
        <div className={`${container} grid grid-cols-2 gap-8 text-center md:grid-cols-4`}>
          <Stat value={<CountUp end={4500} suffix="+" />} label="Learners Placed" />
          <Stat value={<CountUp end={300} suffix="+" />} label="Hiring Partners" />
          <Stat value={<CountUp end={10} />} label="Centres & Online" />
          <Stat value={<CountUp end={98} suffix="%" />} label="Placement Success Rate" />
        </div>
      </section>
      ...
      <section className="py-12 sm:py-14 bg-gradient-to-br from-navy via-[oklch(0.25_0.08_252)] to-navy text-white relative overflow-hidden">
        ...
        <div className={`${container} relative text-center`}>
          ...
          <h2 className="mt-4 text-3xl font-bold sm:text-5xl">Ready to Build a High-Growth Career?</h2>
