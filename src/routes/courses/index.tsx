...
export const Route = createFileRoute("/courses/")({
  head: () => ({
    meta: [
      { title: "Courses — Finprov Programs in Finance, Analytics & Marketing" },
      {
        name: "description",
        content:
          "Browse Finprov's job-assured, certification, and executive programs across finance, analytics, marketing, technology, and management.",
      },
    ],
  }),
        ...
        <div className={`${container} relative grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center`}>
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-gold/40 bg-gold/10 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-gold">
              <Sparkles className="h-3.5 w-3.5" /> Job-Oriented Certification Programs
            </div>
            ...
            >
              Future-Ready Programs <br className="hidden sm:inline" />
              Tailored for You
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 15 }}
            ...
            >
              {courses.length} programs across finance, taxation, analytics, digital marketing, and Gulf careers.
              Filter by category or track to find your fit.
            </motion.p>
