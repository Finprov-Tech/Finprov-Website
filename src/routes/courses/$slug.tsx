...
export const Route = createFileRoute("/courses/$slug")({
  ...
  head: ({ loaderData }) => {
    ...
    const title = loaderData.seoTitle || `${loaderData.title} | Finprov Learning`;
    const description = loaderData.metaDescription || loaderData.heroDesc || loaderData.shortDesc;
    const canonical = loaderData.canonicalUrl || `https://finprov.com/courses/${loaderData.slug}/`;
    const image = loaderData.image ? `https://finprov.com${loaderData.image}` : "https://finprov.com/finprov-wordmark.jpeg";
    ...
    return {
      meta: [
        ...
        { property: "og:site_name", content: "Finprov Learning" },
...
// Color map for category-based accent
...
function CourseDetail() {
  ...
  // Tab state for "What does this course have to offer?" section
        ...
        <div className={`${container} relative grid gap-12 lg:grid-cols-[1.3fr_0.9fr] lg:items-center`}>
          <div>
            ...
            >
              ...
              {/* Hero Paragraph (Exact text from original site hero) */}
          ...
          {/* Right: Clean Hero Course Photo Card */}
          <motion.div
      ...
      <section className="py-16 sm:py-24">
        <div className="mx-auto w-full max-w-[1150px] px-5 sm:px-8">
          <div className="space-y-20">
            ...
            {/* ── EXACT COURSE SNAPSHOT SECTION (MATCHING ORIGINAL SITE) ── */}
            <Reveal id="snapshot">
              <div className="text-left">
                ...
                {/* 3 Stats Box (Matching Original Site Image 2) */}
                ...
                {/* Main Paragraph (Exact text from original site Course Snapshot section) */}
            ...
            {/* ── WHAT DOES THIS COURSE HAVE TO OFFER? (TABBED SECTION) ── */}
            <Reveal id="offer">
